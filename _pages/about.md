...
Hello 👋! I’m Zirui Song, a dedicated Software Engineering undergraduate in my fourth year at the University of Technology Sydney (UTS). My journey in engineering began from a deep fascination with the possibilities that software solutions can offer to complex problems. This curiosity has evolved into a specialized focus on Artificial Intelligence and Natural Language Processing, where I currently contribute to the cutting edge of multimodal AI research.

Since October 2023, I have been a proud member of the <a href="https://utsnlp.github.io/">UTS-NLP</a> team, where I receive guidance from <a href="https://profiles.uts.edu.au/Ling.Chen">Prof. Ling Chen</a> and mentorship from <a href="https://mengfn.github.io/">Prof. Meng Fang</a>. My academic path has also been enriched by the mentorship of <a href="https://dayan-guan.github.io/">Prof. Dayan Guan</a> at ROSE Lab, who introduced me to scientific research, and <a href="https://scholar.google.com.au/citations?hl=en&user=COUnAF4AAAAJ&view_op=list_works&sortby=pubdate">Prof. Xiuying Chen</a> at MBZUAI, under whose supervision I am exploring advanced topics in NLP as a visiting student.

My research is driven by a commitment to integrate multimodal information to enhance the performance of large language models, exploring applications in geolocation and embodied AI. Moreover, I am passionate about addressing the challenges in trustworthy AI, specifically the security aspects of multimodal language models in the vision and audio modalities. I am fortunate to have my work recognized with multiple paper acceptances at prestigious conferences like NAACL, EMNLP, and ECCV, reflecting my active contribution to the field of AI research.
